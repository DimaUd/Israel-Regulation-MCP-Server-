...
export const BUSINESS_SECTORS: Record<string, BusinessComplianceGuide> = {
  ...
  agriculture: {
    sector: 'agriculture',
    name: 'חקלאות, גידול עופות, לולים ובעלי חיים',
    description: 'הקמה והפעלה של משקי גידול עופות, לולים להטלה ופטם, בקר, צאן ומשקים חקלאיים',
    primaryMinistry: 'משרד החקלאות וביטחון המזון',
    secondaryMinistries: ['המשרד להגנת הסביבה', 'משרד הבריאות', 'רשות מקרקעי ישראל', 'רשות מקומית / מועצה אזורית'],
    requiredLicenses: [
      'רישיון עסק לפי צו רישוי עסקים (פריט 3.4 - משקי עופות ולולים)',
      'אישור השירותים הווטרינריים במשרד החקלאות (תוכנית ביו-סקיוריטי, חיסונים ובריאות העוף)',
      'היתר בנייה כחוק מוועדת התכנון והבנייה להקמת מבני הלול לפי תב"ע חקלאית',
      'אישור המשרד להגנת הסביבה לטיפול בשפכים, פינוי פגרים וזבל לולים ומניעת מטרדי ריח וזבובים',
    ],
    keyLegislation: [
      ...
      'תקנות צער בעלי חיים (הגנה על בעלי חיים (הובלת עופות), התשע"ב-2011',
      'תקנות הרופאים הווטרינרים (כשירויות לעיסוק ברפואה וטרינרית - חיסון עופות), התשנ"ד-1994',
      'פקודת מחלות בעלי חיים [נוסח חדש], התשמ"ה-1985',
      'חוק צער בעלי חיים (הגנה על בעלי חיים), התשנ"ד-1994',
    ],
    complianceRequirements: [
      'שמירה על מרחקי הפרדה מינימליים ממבני מגורים, בתי ספר וגבולות מגרש למניעת מפגעים סביבתיים',
      'הטמעת אמצעי ביו-אבטחה (Biosecurity) מחמירים בכניסה ללול למניעת שפעת העופות ומחלות מידבקות',
      'ביצוע חיסונים שגרתיים ומעקב וטרינרי מתועד לפי תקנות השירותים הווטרינריים',
      'עמידה בתקנות רווחת בעלי חיים ואיסור צער בעלי חיים (אוורור, טמפרטורה, צפיפות גידול והזנה ראויה)',
      'הסדרת פינוי פגרים וזבל עופות למתקני קומפוסטציה או כילוי מורשים בלבד',
    ],
    keyRisks: [
      'הוצאת צו סגירה מנהלי על ידי השירותים הווטרינריים או הרשות המקומית',
      'השמדת להקות עופות וסגר וטרינרי בעת התפרצות שפעת העופות או סלמונלה',
      'קנסות ותביעות פליליות בגין מטרדי ריח קשים, זיהום מקורות מים או עבירות צער בעלי חיים',
    ],
    mcpQuerySuggestions: ['משקי עופות ולולים', 'מחלות בעלי חיים עופות', 'צער בעלי חיים הובלת עופות', 'רישוי עסקים חקלאות'],
  },
  aviation: {
    sector: 'aviation',
    name: 'תעופה, כלי טיס בלתי מאוישים ורחפנים',
    description: 'הפעלת שירותי תעופה מסחרית, רחפנים מסחריים (כטב"ם) והשכרת כלי טיס',
    primaryMinistry: 'משרד התחבורה והבטיחות בדרכים / רשות התעופה האזרחית (רת"א)',
    secondaryMinistries: ['משרד הביטחון', 'משטרת ישראל', 'רשות שדות התעופה', 'רשות מקרקעי ישראל'],
    requiredLicenses: [
      'רישיון מפעיל אווירי (AOC) מרת"א עבור תעופה מסחרית',
      'רישיון מטיס פנים ארצי / מטיס רחפנים מסחרי (מעל 4 ק"ג או למטרות מסחריות)',
      'רישום כלי טיס / רחפן בפנקס הרישום של רת"א וסימונו בתווית זיהוי',
      'פוליסת ביטוח חבות צד שלישי תקפה לפי חוק הטיס',
    ],
    keyLegislation: [
      'חוק הטיס, התשע"א-2011',
      'חוק רישוי שירותי התעופה, התשכ"ג-1963',
      'תקנות הטיס (הפעלת כלי טיס בלתי מאויש ורחפנים), התשפ"ב-2022',
      'תקנות הטיס (רשיונות לעובדי טיס), התשמ"א-1981',
    ],
    complianceRequirements: [
      'איסור הטסת רחפנים בקרבת שדות תעופה, מנחתים, בסיסי צה"ל ובקרבת קהל אנשים ללא היתר מיוחד',
      'עמידה בגובה טיסה מרבי מותר (עד 50 מטר לרחפן אלא אם אושר אחרת במערכת U-Space / רת"א)',
      'בדיקות כשירות תקופתיות לכלי הטיס ויומן תחזוקה מסודר',
      'בדיקת קשר עין רציף (VLOS) עם כלי הטיס בזמן הטסה',
    ],
    keyRisks: [
      'החרמת כלי הטיס והגשת כתב אישום פלילי על ידי משטרת ישראל ורת"א',
      'קנסות כבדים בגין חדירה למרחב אווירי סגור או פגיעה בבטיחות הטיסה',
      'שלילת רישיון מטיס ורישיון מפעיל אווירי',
    ],
    mcpQuerySuggestions: ['חוק הטיס', 'הפעלת רחפנים', 'רישוי שירותי התעופה', 'כלי טיס בלתי מאויש'],
  },
};
...
export function extractSearchKeywords(query: string): string[] {
  ...
  const stopWords = new Set([
    'מה', 'מותר', 'אסור', 'איך', 'כיצד', 'האם', 'רוצה', 'לדעת', 'לפתוח', 'להקים',
    'לעשות', 'שלי', 'שלך', 'של', 'את', 'על', 'בנושא', 'לגבי', 'עבור', 'בישראל',
    'חוק', 'דין', 'חוקים', 'האם', 'מתי', 'איפה', 'היכן', 'כמה', 'אפשר', 'צריך',
    'נדרש', 'האם', 'יש', 'אין', 'כללי', 'אודות', 'בקשר', 'תגיד', 'לי', 'אני',
  ]);
...
export function detectSectorFromQuery(query: string): string | null {
  const q = query.toLowerCase();
  if (/עוף|עופות|לול|לולים|תרנגול|תרנגולות|פטם|הטלה|חקלא|משק|בקר|צאן|דיר|רפת|וטרינר/i.test(q)) {
    return 'agriculture';
  }
  if (/רחפן|רחפנים|מטוס|מטוסים|תעופה|טיס|כטב|כטב"מ|מסוק|נמל תעופה|שדה תעופה/i.test(q)) {
    return 'aviation';
  }
  if (/מסעד|בית קפה|קפה|מזון|אוכל|אלכוהול|בר|פאב|קייטרינג|מאפיה|מטבח/i.test(q)) {
    return 'restaurant';
  }
  if (/תשלום|פינטק|אשראי|ארנק|בנק|הלוואות|מידע פיננסי|הלבנת הון/i.test(q)) {
    return 'fintech';
  }
  if (/סייבר|בינה מלאכותית|ai|אלגוריתם|ענן|מאגר מידע|הגנת הפרטיות|dpo/i.test(q)) {
    return 'ai_cyber';
  }
  if (/סולאר|פאנל|חשמל|אנרגיה|פוטו-וולטאי|מונה נטו|אגירה/i.test(q)) {
    return 'solar_energy';
  }
  if (/יבוא|יצוא|מכס|תקן|יבואן|תקינה|שחרור טובין/i.test(q)) {
